...
urlpatterns = [
    ...
    path('admin/hide_comment/<int:comment_id>/', views.hide_comment, name='hide_comment'),
    path('admin/show_comment/<int:comment_id>/', views.show_comment, name='show_comment'),
